...
$( document ).ready(function() {
    ...
    //   });
      ...
      $("#dropdownAge ul li a").click(function(){
        console.log( "which age is clicked: " + this);
        $(this).parents(".dropdown").find('.btn').html($(this).text() + ' <span class="caret"></span>');
        $(this).parents(".dropdown").find('.btn').val($(this).data('value'));
      });
...
function startMonitoring () {
        if ( myState == undefined ){
           ...
           // $("p").css("background-color", "rgb(0,0,255)");
            $("p").append("<br> <b>"+ myStateName + " : " +myDistName + ", above: " + myAge +" years. Monitoring is started</b>.<br>");
            updateScroll();
            }
    }
...
function clearlog () {
    ...
    $("p").empty();
    $("p").append("<br> <b>Log is cleared</b>.<br>");
    updateScroll();
    }
